...
*/
#ifndef _IF2K_MULTISCANNER_H
#define _IF2K_MULTISCANNER_H
      ...
      )
    {
      ...
      if( enable_bits && (1<<category) )
      {
        ...
        if( util::file_exists( input_filename ) )
        {
          ...
          if( !scanner )
          {
            if2k_throw( "new url_scanner_precompiled_t" );
          }
        }
      }
      return scanner;
      ...
      )
    {
      ...
      if( enable_bits && (1<<category) )
      {
        ...
        if( util::file_exists( input_filename ) )
        {
          ...
          if( !scanner )
          {
            if2k_throw( "new alphanumeric_scanner_precompiled_t" );
          }
        }
      }
      return scanner;
      ...
      )
    {
      ...
      if( enable_bits && (1<<category) )
      {
        ...
        if( util::file_exists( input_filename ) )
        {
          ...
          if( !scanner )
          {
            if2k_throw( "alphanumeric_scanner_t" );
          }
        }
      }
      return scanner;
